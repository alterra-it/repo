Функция ПолучитьВнутреннийНомерПользователя(ТекПользователь =  Неопределено) Экспорт
	...
	Запрос.УстановитьПараметр("Вид", Справочники.ВидыКонтактнойИнформации.НайтиПоНаименованию("Рабочий телефон", Истина));
...
Функция ПроверитьПервыйЗапуск() Экспорт
	...
	Если ПолучитьЗначениеНастройки("ПервыйЗапуск") = Неопределено Тогда
		...
		Если Справочники.ВидыКонтактнойИнформации.ПростыеЗвонкиТелефон.Используется = Ложь Тогда
			...
			ПараметрыВида.Вид = Справочники.ВидыКонтактнойИнформации.НайтиПоНаименованию("Рабочий телефон", Истина);
			УправлениеКонтактнойИнформацией.УстановитьСвойстваВидаКонтактнойИнформации(ПараметрыВида);
		КонецЕсли;		
		
		ВидПростыеЗвонки = Справочники.ВидыКонтактнойИнформации.НайтиПоНаименованию("Рабочий телефон", Истина);
