...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("ПараметрОтбора",               ПоказыватьТолькоРеализации);
	
	СтруктураБыстрогоОтбора = Неопределено;
	Параметры.Свойство("СтруктураБыстрогоОтбора", СтруктураБыстрогоОтбора);
	
	СписокВыбора_ = Элементы.ОтборСрокВыполнения.СписокВыбора;
	ОтборыСписковКлиентСервер.ЗаполнитьСписокВыбораОтбораПоАктуальности(СписокВыбора_);
	...
	ОтборыСписковКлиентСервер.ОтборПоАктуальностиПриСозданииНаСервере(Список, Актуальность, СписокВыбора_, ДатаСобытия, СтруктураБыстрогоОтбора);
...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	ОтборыСписковКлиентСервер.ОтборПоАктуальностиПриЗагрузкеИзНастроек(Список, Актуальность, СписокВыбора_, ДатаСобытия, СтруктураБыстрогоОтбора, Настройки);
...
&НаКлиенте
Процедура СуммаЗаказаОтПриИзменении(Элемент)
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "СуммаДокумента", СуммаЗаказаОт*1000, ВидСравненияКомпоновкиДанных.БольшеИлиРавно,, ЗначениеЗаполнено(СуммаЗаказаОт));	
КонецПроцедуры

&НаКлиенте
Процедура СуммаЗаказаОтОчистка(Элемент, СтандартнаяОбработка)
	Если НЕ ЗначениеЗаполнено(СуммаЗаказаОт) Тогда
		СтандартнаяОбработка = Ложь;
	КонецЕсли;
КонецПроцедуры

&НаКлиенте
Процедура СрокАктивностиЗаказаДнейПриИзменении(Элемент)
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "СрокАктивностиЗаказа", СрокАктивностиЗаказаДней, ВидСравненияКомпоновкиДанных.БольшеИлиРавно,, ЗначениеЗаполнено(СрокАктивностиЗаказаДней));	
КонецПроцедуры

&НаКлиенте
Процедура СрокАктивностиЗаказаДнейОчистка(Элемент, СтандартнаяОбработка)
	Если НЕ ЗначениеЗаполнено(СрокАктивностиЗаказаДней) Тогда
		СтандартнаяОбработка = Ложь;
	КонецЕсли;
КонецПроцедуры
...
Процедура ОсновнойМенеджерПриИзменении(Элемент)
	 ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "ОсновнойМенеджер", ОсновнойМенеджер, ВидСравненияКомпоновкиДанных.Равно,, ЗначениеЗаполнено(ОсновнойМенеджер));	
КонецПроцедуры
...
&НаКлиенте
Процедура ПоказыватьТолькоРеализацииПриИзменении(Элемент)
	Список.Параметры.УстановитьЗначениеПараметра("ПараметрОтбора", ПоказыватьТолькоРеализации);
КонецПроцедуры
