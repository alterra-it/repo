...
Процедура СкопироватьВБуфер(Команда)
	...
	HTML.parentWindow.clipboardData.setData("Text",СокрЛП(НомерТелефона));
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаголовокЗвонка = "Вы совершили звонок на неизвестный номер";
	...
	ЗаголовокЗвонка = "Входящий звонок в "+Формат(ТекущаяДата(),"ДЛФ=T");
