...
&ИзменениеИКонтроль("КонтрольИспользованияАналитикиОборотов")
Процедура Док_КонтрольИспользованияАналитикиОборотов(КомпоновщикНастроек)
...
&ИзменениеИКонтроль("НастроитьПараметрыОтчетаПоВариантуОтчета")
Процедура Док_НастроитьПараметрыОтчетаПоВариантуОтчета(НастройкиОтчета, НовыеНастройкиКД, НовыеПользовательскиеНастройкиКД)
